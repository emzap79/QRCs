...
\vskip -0.2cm
\section{Misc Ex Commands (\enter)}{:help holy-grail }
...
\section{Patterns (differences to Perl)}{:help pattern }
...
\section{Buffer Shortcuts}{:h ctrl-w }
...
\cmdL{:digraphs\ \or\ :h digraph-table}{complete list of all digraphs}
...
\cmdL{:h /zero-width}{matches with `zero-width' pattern}
