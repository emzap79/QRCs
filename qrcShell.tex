...
\subsection{Options}{you may append as many options to a history command as you
want, e.~g. you could do a: $!!:\$:p$ (prints last argument of before executed
command)}
...
\cmdS{\ctrl \#}{prepend hash on command, then jump to next line (... and reedit later)}
