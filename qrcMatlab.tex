...
\def\versionnumber{0.3}  % Version of this reference card
...
\cmdOper{sets}	{the default format how $MATLAB$ displays numbers.}
...
% (Unlike C or Java, in $MATLAB$ a command is normally terminated by a newline
% character.)
