...
\cmdS{checkout}	{Checkout a branch or paths to the working tree}
...
\cmdOpt{m}	{Set comment for commitment -- correcting it with adding {\tt --amend}}
...
\cmdS{reset}	{Reset current HEAD to the specified state (Remove a {\it file} from
staging area)}
