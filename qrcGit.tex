...
\def\copyrightnotice{
\vfill
Present qrc was originally created by Gabriel B. Burca
\hrule\smallskip\begingroup\smallrm
% \centerline{\version. Copyright \copyright\ \year\ Jonas Petong}
\centerline{Send comments or corrections to Jonas Petong}
...
and was then modified to my own use.
\endgroup}
...
\cmdOptB{m}	{Set comment for commitment -- correct it with prepending {\tt --amend} to argument}
...
\cmdOptLB{stat}	{precise output with some stats}
...
\cmdSB{reset}	{Reset current HEAD to the specified state (Remove a $file$ from staging area)}
...
\cmdSB{remote}	{Manage set of tracked repositories}
\cmdOptB{v}	{show details about the remotes}
