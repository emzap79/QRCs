...
Prefix key is set to \key{ctrl-b} by default. You can
change that behaviour to e.g. \key{ctrl-a} by adding the following
...
\cmdS{\ctrl b!}	{close all panes but this one}
\cmdS{\ctrl b\key{\arrows}}	{switch panes}
\cmdS{\ctrl b$n$}	{change to buffer $0 \ldots n$}
\cmdL{\ctrl b\key{M - \arrows } \ctrl bz}	{resize / full-screen pane}
\cmdS{\ctrl b$\lbrace$~\ctrl b$\rbrace$}	{swap with prev / next pane}
