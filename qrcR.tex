...
{The Reference Cheat was first created by Tom Short, EPRI PEAC, in
    2004-10-21. I modified the original document so it fits my other reference
    cards on GitHub; all of its original content has been preserved!}
...
\cmdExmpl{\\d\ldots ame(v=1:4,ch=c("a","B","c","d"),n=10)}	{shorter vectors are recycled to the length of the longest}
