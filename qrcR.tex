...
\cmdExmpl{\\ {\smalltt write.table(x,"clipboard",sep="\bs t",col.names=NA)}}{To
write a table to the clipboard for Excel, use}
...
\cmdOper{{\tt \%y}}	{Year without century (00--99).\\(Don't use due to ambiguousness!)}
...
\section{Graphical parameters}{These can be set globally with {\tt par(...)}; many can be passed as
